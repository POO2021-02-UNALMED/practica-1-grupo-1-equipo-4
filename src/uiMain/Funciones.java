...
public class Funciones {
	...
	public static void buscarPorViejo(Cine cine,int cedula) {
		int opcion=0;
		System.out.print("Quiere buscar pel�cula por:\n"
				+ "1. Recomendadas\n"
				+ "2. Funciones\n"
				+ "3. Pelicula");
		Scanner entrada = new Scanner(System.in);
	...
	public static void recomendadas(Cine cine,int cedula) {
		int opcion=0;
		System.out.println(cine.verFuncion(cine.BuscadorCliente(cedula))); //Busca al cliente por la cedula en el cine, luego llama al m�todo de funcion
	...
	public static void comprar(Cine cine, int cedula) {
		...
		System.out.print("Ingrese el c�digo de la funci�n a la que desea asistir: ");
		...
		System.out.print("Ingrese el c�digo del boleto que desea comprar: ");
